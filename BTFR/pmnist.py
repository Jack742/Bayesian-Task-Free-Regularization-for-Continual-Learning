...
strategy_names = ['btfr_ewc']#['ewc_base','ewc_tf', 'btfr_ewc', 'mas_base','mas_tf', 'btfr_mas','naive']
...
ewc = EWCPlugin(ewc_lambda=40, mode='online', decay_factor=1.0,keep_importance_data=False)
...
strategies = { 
    ...
    #             "labelled_btfr_ewc": BayesianCL(model, optimizer, criterion, beta=0.5,plugins=[wlbtfrmas],num_test_repeats=num_model_reruns,train_mb_size=1, train_epochs=1,
